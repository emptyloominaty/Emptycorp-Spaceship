class Generator extends Part {
    ...
    constructor(id,weight,name,type,output,defaultOn,efficiency = 100) {
        ...
        this.output = output
        if (type === "H2FuelCell") {
            this.consumption = ((output/1000)/(0.0000000033*(efficiency/100)))/3600 // l/hour   (3.3Wh per L)
        ...
        } else if (type === "H2FusionReactor") {
            this.consumption = ((output/1000)/(0.014883715*(efficiency/100)))/3600 // l/hour  (177.716gW per kg)  //0.00008375 kg/l
            this.generatorFuelType = "H2"
